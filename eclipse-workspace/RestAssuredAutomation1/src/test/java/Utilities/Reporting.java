...
public class Reporting  extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext)
	{
		...
		//String RName="Test-Report.html";
		//htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+ "/test-output/"+RName);//specify location of the report
		...
		htmlReporter.config().setDocumentTitle("Rest Assured"); // Tile of report
	...
	public void onTestFailure(ITestResult tr)
	{
		...
		//String sname="Screeshot1.png";
		//String screenshotPath=System.getProperty("/Users/diva/eclipse-workspace/inetBanking/Screenshots/"+sname);
